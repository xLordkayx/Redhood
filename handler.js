      ...
      if (chat.welcome) {
        ...
        for (let user of participants) {
          ...
          try {
            ...
            console.error(`Error retrieving profile picture: ${error}`)
            pp = 'https://files.catbox.moe/2tgnpj.jpeg' // Assign default image URL
            ppgp = 'https://files.catbox.moe/e7g7d3.jpeg' // Assign default image URL
          } finally {
            ...
            try {
              ...
              this.sendMessage(id, {
                ...
                contextInfo: {
                  mentionedJid: [user],
                  externalAdReply: {
                    title: 'lordkay da maker ',
                    body: 'Goodbye from  Group',
                    thumbnailUrl: leaveApiUrl,
                    sourceUrl: 'https://whatsapp.com/channel/0029VajNrqi7dmegpU2Yla1f',
                    mediaType: 1,
                    renderLargerThumbnail: true,
                  },
                },
